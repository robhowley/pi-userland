...
| [`pi-merge-ready`](packages/pi-merge-ready/README.md)             | See whether a GitHub pull request can merge, understand its blockers, and queue one bounded agent repair attempt when possible.                                                                        |
