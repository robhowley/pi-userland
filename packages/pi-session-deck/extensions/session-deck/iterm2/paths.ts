...
export const SESSION_DECK_ITERM2_WEB_SHARED_UI_FILENAME = 'session-deck-ui.js';
export const SESSION_DECK_ITERM2_WEB_HOST_FILENAME = 'iterm2-host.js';
...
export function getSessionDeckIterm2WebAssetPaths(webRootPath: string): {
  ...
  return {
    ...
    sharedUiPath: join(webRootPath, SESSION_DECK_ITERM2_WEB_SHARED_UI_FILENAME),
    hostPath: join(webRootPath, SESSION_DECK_ITERM2_WEB_HOST_FILENAME),
